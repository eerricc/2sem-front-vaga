...
const Home = () => {
  return (
    <div className=''>
      <img src={banner} alt="" className='w-full h-[700px]'/>
      <section className='flex w-[90%] mx-auto my-4 justify-between'>
        <img src={marvel} alt="" className='h-[500px] w-[40%] rounded-[30%]'/>
        <div className='flex flex-col items-center bg-[#FF9FC5] w-[40%] p-10 rounded-[10%] h-[500px]'>
      ...
      <section className='flex w-[90%] mx-auto my-4 justify-between'>
        <div className='flex flex-col justify-center items-center bg-[#FF9FC5] w-[40%] p-10 rounded-[10%] h-[500px]'>
        ...
        <img src={DC} alt="" className='h-[500px] w-[40%] rounded-[30%]'/>
      </section>
    </div>
  )
}
